...
def warning_widget(size, screen_size, text, font, text_color=(255, 255, 255, 255), z_index=99, fill=(0, 0, 0, 160)):
    """
    Create an ImageWidget that is centered on the screen.
